...
'USDC_BEP20':'0xe58abc5364aa6bc660911c3856630341c6fd1b44',
}
...
async def admin_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👥 View Pending Users", callback_data="admin_view_pending")],
...
async def handle_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif query.data == 'admin_view_pending':
        await view_pending_users(update, context) 
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(handle_user_approval, pattern=r"^(approve|reject)_user_\d+$"))
    app.add_handler(CallbackQueryHandler(check_approval_status, pattern=r"^check_approval_status$"))
    app.add_handler(CommandHandler("pending", view_pending_users))
